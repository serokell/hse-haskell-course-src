...
\item Let us have a look at the following functions:
    ...
    \end{minted}
\item These function are similar. Here we have a unary function that we carry through a parametrised type.
...
\begin{frame}[fragile]
\frametitle{An example of a \verb"Functor" instance}
...
The derived instance in this example is equivalent to our version.
...
Any \verb"Functor" instance has to obey the following axioms:
