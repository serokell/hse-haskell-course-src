...
\begin{itemize}
  ...
  \item The type of the \verb"Point" data constructor. The \verb"Point" from the left is a type constructor that has its type (kind).
  \begin{minted}{haskell}
  > :type Point
  Point :: a -> a -> Point a
  > :k Point
...
\end{block}
\begin{itemize}
  \item The universal property is inductively
