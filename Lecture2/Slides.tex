...
\verb"Case"-expressions allows one to perform case analysis within a function.
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Haskell functions are (mostly) pure ones, but Haskell isn't confluent as a version of the lambda calculus
    }
  \end{itemize}
\end{frame}
